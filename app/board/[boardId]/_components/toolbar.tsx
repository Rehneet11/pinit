...
import { Circle, Ellipsis, MousePointer2, Pencil, Redo2, Square, StickyNote, Type, Undo2 } from "lucide-react";
...
export const Toolbar = ({canvasState,
    setCanvasState,
    undo,
    redo,
    canUndo,
...
export const ToolbarSkeleton=()=>{
    return(
        <div className="fixed top-1/2 left-2 transform -translate-y-1/2 flex flex-col gap-y-4 bg-white h-[360px] w-[52px] shadow-md rounded-md"/>
