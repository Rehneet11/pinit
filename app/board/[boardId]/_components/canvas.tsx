...
export const Canvas=({boardId}:CanvasProps)=>{
    ...
    const continueDrawing = useMutation((
        ...
        if(
            canvasState.mode!==CanvasMode.Pencil || e.buttons!==1 || pencilDraft==null
        ){
            return;
        }
        setMyPresence({
    ...
    return(
        <main className="h-full w-full relative bg-neutral-150 touch-none">
            ...
            onPointerDown={onPointerDown}>
                <g style={{
                    ...
                    {canvasState.mode === CanvasMode.SelectionNet && canvasState.current != null &&(
                        <rect className="fill-blue-400/5 stroke-blue-400 stroke-1"
